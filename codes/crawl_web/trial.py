...
if r.status_code == 200:
    with open(os.path.join(os.path.dirname(__file__), 'data', url1.split('/')[-1]), 'wb') as f:
        f.write(r.content)
...
open(os.path.join(os.path.dirname(__file__), 'data', url2.split('/')[-1]), 'wb').write(r.content)
